...
const Archive = () => {
    const[current,setcurrent]=useState({current:1})
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-9 col-md-8 col-sm-12 col-xs-12">
                            <section className="terms-items">
                                <div className="row">
                                    {Pagination(courses,2,current.current).map(course => (
                                        <div key={course.id} className="col-lg-4 col-md-4 col-sm-6 col-xs-12 term-col">
                                            <article>
                                                <a href="" className="img-layer"><img src={`http://127.0.0.1:8000/storage/images/${course.imageUrl}`} /></a>
                                ...
                                <nav aria-label="Page navigation">
                                    <ul className="pagination justify-content-center">
                                        ...
                                        {Paginate(courses).map(page=>(
                                             <li class="page-item"><Link class="page-link" onClick={()=>setcurrent({current:page})}>{page}</Link></li>
                                    ))}
                                        <li className="page-item">
